...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'mb-4' do |b|
    ...
    b.use :input,
          class: 'shadow appearance-none border border-gray-300 rounded w-full py-2 px-3 bg-white \
                  focus:outline-none focus:ring-0 focus:border-[#019863] text-gray-400 leading-6 \
